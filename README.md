...
Here is an image of the Application, you can see a green around Bob because he just mined the last block :

<img src="img/1.JPG"/>

To use the application:
- Clone this repository
- go to the /backend folder and do `npm install` and then do `node server.js`
- go to the /app folder and do `npm install` and then do `npm start`

Then you can see your application running on port 3000 at the following address : http://localhost:3000/
